    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            $("#btnSet").bind('click', function ()
            {
				...
				$.get("locationinfo/roomAction.action",
				"lno="+cho+"&bno="+bno,
        ...
        var llno=document.getElementById("RoomNo").value;
        $.post(
           		"<%=basePath%>locationinfo/SetNewlAction.action",
           		{'lno':llno,'newSno':newsno},
