...
<html>
  <head>
    ...
    <script type="text/javascript"> 
        ...
        $(function ()
        {
            ...
            {
				var cho = $("#AreaNo").val();
				$.get("locationinfo/areaAction.action",
				"ano="+cho,
        ...
        var aano=document.getElementById("AreaNo").value;
        $.post(
           		"<%=basePath%>locationinfo/SetNewAction.action",
           		{'ano':aano,'newSno':newsno},
  ...
  <body style="padding:10px">
		...
		<span>区域负责人查询及修改</span>
		</div>
		<div class="content">
  		<p>
  		<label>区域：</label>
  		<select name="AreaNo" id="AreaNo" ltype="select">
